...
void run_demo(gpRender gr){
	...
	*/
	...
	Sprite sector1ent(sector1Rect, sector1Tex);
	sector1ent.isUI();
	...
	Sprite sector2ent(sector2Rect, sector2Tex);
	sector2ent.isUI();
	...
	Sprite sector3ent(sector3Rect, sector3Tex);
	sector3ent.isUI();
	...
	Sprite sector4ent(sector4Rect, sector4Tex);
	sector4ent.isUI();
	...
	Sprite sector5ent(sector5Rect, sector5Tex);
	sector5ent.isUI();
	...
	Sprite sector6ent(sector6Rect, sector6Tex);
	sector6ent.isUI();
	...
	Sprite sector7ent(sector7Rect, sector7Tex);
	sector7ent.isUI();
	...
	Sprite sector8ent(sector8Rect, sector8Tex);
	sector8ent.isUI();
